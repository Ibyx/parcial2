...
require_once("controllers/juego_controllers.php");
?>
<br><br><br>
    <div class="container">
        <h1 class="text-center" id="catalogo">CATALOGO DE KEYS</h1>
        ...
        <div class="row">
            ...
            <?php foreach ($resultado as $producto) {
                if ($h1 == 1) {
                    if (count($resultado) == $n) {
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="card" style="width: 18rem;">
                                <img src="../img/juego<?php echo $resultado["id"] ?>.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card" style="width: 18rem;">
                            <img src="../img/juego<?php echo $producto["id"] ?>.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
